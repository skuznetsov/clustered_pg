...
PERF_ROWS ?= 1024
PERF_ITERS ?= 2000
PERF_CHURN_ROWS ?= 5000
PERF_CHURN_ITERS ?= 2000
PERF_PORT ?= 65463
PERF_OUT ?=
PERF_OUT_DIR ?= /private/tmp
PERF_MEDIAN_RUNS ?= 5
PERF_REF ?=
PERF_NEW ?=
PERF_REF_DIR ?=
...
PERF_SET_MIN_SAMPLES ?=
PERF_SELFTEST_TMP_ROOT ?= /private/tmp
...
help:
	...
	@echo "  make concurrency-smoke CONCURRENCY_SMOKE_DB=<db>"
	@echo "  make fastpath-stress STRESS_CYCLES=<n> STRESS_PORT=<port>"
	@echo "  make fastpath-perf-probe PERF_ROWS=<n> PERF_ITERS=<n> PERF_CHURN_ROWS=<n> PERF_CHURN_ITERS=<n> PERF_PORT=<port>"
	@echo "  make fastpath-perf-probe-median PERF_MEDIAN_RUNS=<n> PERF_ROWS=<n> PERF_ITERS=<n> PERF_CHURN_ROWS=<n> PERF_CHURN_ITERS=<n> PERF_PORT=<base_port> PERF_OUT_DIR=<abs_dir>"
	@echo "  make fastpath-perf-compare PERF_REF=<path> PERF_NEW=<path> PERF_MAX_SLOWDOWN=<ratio>"
	@echo "  make fastpath-perf-compare-median PERF_REF_DIR=<dir> PERF_NEW_DIR=<dir> PERF_MAX_SLOWDOWN=<ratio> PERF_SET_STAT_MODE=<median|p95|trimmed-mean> PERF_SET_MIN_SAMPLES=<n>"
	@echo "  make fastpath-perf-compare-selftest PERF_SELFTEST_TMP_ROOT=<abs_tmp_dir>"
	@echo "  make fastpath-perf-probe-selftest PERF_RUNTIME_SELFTEST_TMP_ROOT=<abs_tmp_dir> PERF_RUNTIME_SELFTEST_PORT=<port> PERF_RUNTIME_SELFTEST_ROWS=<n> PERF_RUNTIME_SELFTEST_ITERS=<n> PERF_RUNTIME_SELFTEST_CHURN_ROWS=<n> PERF_RUNTIME_SELFTEST_CHURN_ITERS=<n>"
	@echo "  make fastpath-perf-probe-selftest-high-churn PERF_RUNTIME_SELFTEST_TMP_ROOT=<abs_tmp_dir> PERF_RUNTIME_SELFTEST_HIGH_PORT=<port> PERF_RUNTIME_SELFTEST_HIGH_ROWS=<n> PERF_RUNTIME_SELFTEST_HIGH_ITERS=<n> PERF_RUNTIME_SELFTEST_HIGH_CHURN_ROWS=<n> PERF_RUNTIME_SELFTEST_HIGH_CHURN_ITERS=<n>"
	@echo "  make runtime-profile-behavior-selftest PERF_RUNTIME_SELFTEST_TMP_ROOT=<abs_tmp_dir>"
	@echo "  make runtime-profile-behavior-selftest-validation PERF_RUNTIME_SELFTEST_TMP_ROOT=<abs_tmp_dir>"
	@echo "  make runtime-guards-selftest PERF_RUNTIME_SELFTEST_TMP_ROOT=<abs_tmp_dir>"
	@echo "  make runtime-guards-selftest-summary PERF_RUNTIME_SELFTEST_TMP_ROOT=<abs_tmp_dir> RUNTIME_GUARD_SUMMARY_FORMAT=<kv|json>"
	...
	@echo "  make unnest-ab-probe UNNEST_AB_RUNS=<n> UNNEST_AB_BATCH_SIZE=<n> UNNEST_AB_BATCHES=<n> UNNEST_AB_SELECT_ITERS=<n> UNNEST_AB_PROBE_SIZE=<n> UNNEST_AB_PORT=<port> UNNEST_AB_OUT=<path|auto|auto:<abs_dir>> UNNEST_AB_KEYCACHE_TRIGGER=<n> UNNEST_AB_KEYCACHE_MIN_DISTINCT=<n> UNNEST_AB_KEYCACHE_MAX_TIDS=<n> UNNEST_AB_SEGMENT_PREFETCH_SPAN=<n> UNNEST_AB_LOCAL_HINT_MAX_KEYS=<n> UNNEST_AB_ASSUME_UNIQUE_KEYS=<on|off> UNNEST_AB_WARMUP_SELECTS=<n> UNNEST_AB_ALLOW_UNSAFE_UNIQUE=<on|off>"
	@echo "  make unnest-ab-perf-sentinel UNNEST_SENTINEL_RUNS=<n> UNNEST_SENTINEL_BATCH_SIZE=<n> UNNEST_SENTINEL_BATCHES=<n> UNNEST_SENTINEL_SELECT_ITERS=<n> UNNEST_SENTINEL_PROBE_SIZE=<n> UNNEST_SENTINEL_PORT=<port> UNNEST_SENTINEL_KEYCACHE_TRIGGER=<n> UNNEST_SENTINEL_KEYCACHE_MIN_DISTINCT=<n> UNNEST_SENTINEL_KEYCACHE_MAX_TIDS=<n> UNNEST_SENTINEL_SEGMENT_PREFETCH_SPAN=<n> UNNEST_SENTINEL_LOCAL_HINT_MAX_KEYS=<n> UNNEST_SENTINEL_WARMUP_SELECTS=<n> UNNEST_SENTINEL_ENFORCE_THRESHOLDS=<on|off> UNNEST_SENTINEL_MIN_INSERT_RATIO=<ratio> UNNEST_SENTINEL_MIN_JOIN_UNNEST_RATIO=<ratio> UNNEST_SENTINEL_MIN_ANY_ARRAY_RATIO=<ratio>"
	...
	@echo "  make unnest-ab-startup-sensitivity UNNEST_STARTUP_RUNS=<n> UNNEST_STARTUP_BATCH_SIZE=<n> UNNEST_STARTUP_BATCHES=<n> UNNEST_STARTUP_SELECT_ITERS=<n> UNNEST_STARTUP_PROBE_SIZE=<n> UNNEST_STARTUP_PORT=<port> UNNEST_STARTUP_KEYCACHE_TRIGGER=<n> UNNEST_STARTUP_KEYCACHE_MIN_DISTINCT=<n> UNNEST_STARTUP_KEYCACHE_MAX_TIDS=<n> UNNEST_STARTUP_SEGMENT_PREFETCH_SPAN=<n> UNNEST_STARTUP_LOCAL_HINT_MAX_KEYS=<n> UNNEST_STARTUP_PROBE_SCRIPT=<path>"
	@echo "  make unnest-ab-startup-sensitivity-guard UNNEST_STARTUP_RUNS=<n> UNNEST_STARTUP_BATCH_SIZE=<n> UNNEST_STARTUP_BATCHES=<n> UNNEST_STARTUP_SELECT_ITERS=<n> UNNEST_STARTUP_PROBE_SIZE=<n> UNNEST_STARTUP_PORT=<port> UNNEST_STARTUP_KEYCACHE_TRIGGER=<n> UNNEST_STARTUP_KEYCACHE_MIN_DISTINCT=<n> UNNEST_STARTUP_KEYCACHE_MAX_TIDS=<n> UNNEST_STARTUP_SEGMENT_PREFETCH_SPAN=<n> UNNEST_STARTUP_LOCAL_HINT_MAX_KEYS=<n> UNNEST_STARTUP_GUARD_MAX_INSERT_WARM_OVER_COLD=<ratio> UNNEST_STARTUP_GUARD_MAX_JOIN_UNNEST_WARM_OVER_COLD=<ratio> UNNEST_STARTUP_GUARD_MAX_ANY_ARRAY_WARM_OVER_COLD=<ratio> UNNEST_STARTUP_GUARD_PROBE_SCRIPT=<path>"
	@echo "  make unnest-ab-startup-sensitivity-sentinel UNNEST_STARTUP_RUNS=<n> UNNEST_STARTUP_BATCH_SIZE=<n> UNNEST_STARTUP_BATCHES=<n> UNNEST_STARTUP_SELECT_ITERS=<n> UNNEST_STARTUP_PROBE_SIZE=<n> UNNEST_STARTUP_PORT=<port> UNNEST_STARTUP_KEYCACHE_TRIGGER=<n> UNNEST_STARTUP_KEYCACHE_MIN_DISTINCT=<n> UNNEST_STARTUP_KEYCACHE_MAX_TIDS=<n> UNNEST_STARTUP_SEGMENT_PREFETCH_SPAN=<n> UNNEST_STARTUP_LOCAL_HINT_MAX_KEYS=<n> UNNEST_STARTUP_PROBE_SCRIPT=<path> UNNEST_STARTUP_SENTINEL_PROBE_SCRIPT=<path>"
	@echo "  make pg-core-regression-smoke"
	@echo "  make unnest-ab-probe-profile-throughput UNNEST_AB_RUNS=<n> UNNEST_AB_BATCH_SIZE=<n> UNNEST_AB_BATCHES=<n> UNNEST_AB_SELECT_ITERS=<n> UNNEST_AB_PROBE_SIZE=<n> UNNEST_AB_PORT=<port> UNNEST_AB_OUT=<path|auto|auto:<abs_dir>>"
	@echo "  make unnest-ab-probe-profile-latency UNNEST_AB_RUNS=<n> UNNEST_AB_BATCH_SIZE=<n> UNNEST_AB_BATCHES=<n> UNNEST_AB_SELECT_ITERS=<n> UNNEST_AB_PROBE_SIZE=<n> UNNEST_AB_PORT=<port> UNNEST_AB_OUT=<path|auto|auto:<abs_dir>>"
	@echo "  make unnest-ab-profile-recommend UNNEST_AB_SELECT_ITERS=<n> UNNEST_AB_BATCHES=<n>"
	@echo "  make unnest-ab-probe-profile-auto UNNEST_AB_RUNS=<n> UNNEST_AB_BATCH_SIZE=<n> UNNEST_AB_BATCHES=<n> UNNEST_AB_SELECT_ITERS=<n> UNNEST_AB_PROBE_SIZE=<n> UNNEST_AB_PORT=<port> UNNEST_AB_OUT=<path|auto|auto:<abs_dir>>"
	@echo "  make unnest-ab-probe-profile-calibrated UNNEST_AB_RUNS=<n> UNNEST_AB_BATCH_SIZE=<n> UNNEST_AB_BATCHES=<n> UNNEST_AB_SELECT_ITERS=<n> UNNEST_AB_PROBE_SIZE=<n> UNNEST_AB_PORT=<port> UNNEST_AB_OUT=<path|auto|auto:<abs_dir>> UNNEST_AB_PROFILE_CALIBRATE_RUNS=<n> UNNEST_AB_PROFILE_CALIBRATE_SAMPLES=<n> UNNEST_AB_PROFILE_CALIBRATE_SCORE_MODE=<min|gmean> UNNEST_AB_PROFILE_CALIBRATE_SET_STAT_MODE=<median|p05|p95|trimmed-mean> UNNEST_AB_PROFILE_CALIBRATE_SET_MIN_SAMPLES=<n> UNNEST_AB_PROFILE_CALIBRATE_MIN_SCORE_MARGIN=<ratio> UNNEST_AB_PROFILE_CALIBRATE_MIN_QUANTILE_SCORE_MARGIN=<ratio> UNNEST_AB_PROFILE_CALIBRATE_OUT_ROOT=<abs_dir> UNNEST_AB_PROFILE_CALIBRATE_THROUGHPUT_LOG=<abs_log|abs_dir> UNNEST_AB_PROFILE_CALIBRATE_LATENCY_LOG=<abs_log|abs_dir>"
	@echo "  make unnest-ab-profile-boundary-nightly UNNEST_AB_NIGHTLY_OUT_ROOT=<abs_dir> UNNEST_AB_NIGHTLY_BASE_PORT=<port> UNNEST_AB_NIGHTLY_REPS=<n> UNNEST_AB_NIGHTLY_STRICT_MIN_OBS=<n> UNNEST_AB_NIGHTLY_KEEP_ARTIFACTS=<off|on>"
	@echo "  make unnest-ab-profile-boundary-nightly-selftest UNNEST_AB_SELFTEST_TMP_ROOT=<abs_tmp_dir>"
	@echo "  make unnest-ab-profile-boundary-compare-baseline UNNEST_AB_NIGHTLY_BASELINE=<path> UNNEST_AB_NIGHTLY_OUT_ROOT=<abs_dir> UNNEST_AB_NIGHTLY_BASE_PORT=<port> UNNEST_AB_NIGHTLY_REPS=<n> UNNEST_AB_NIGHTLY_STRICT_MIN_OBS=<n>"
	@echo "  make unnest-ab-profile-boundary-compare-baseline-selftest UNNEST_AB_SELFTEST_TMP_ROOT=<abs_tmp_dir>"
	...
	@echo "  make unnest-ab-gate UNNEST_GATE_REF_RUNS=<n> UNNEST_GATE_NEW_RUNS=<n> UNNEST_GATE_BATCH_SIZE=<n> UNNEST_GATE_BATCHES=<n> UNNEST_GATE_SELECT_ITERS=<n> UNNEST_GATE_PROBE_SIZE=<n> UNNEST_GATE_BASE_PORT=<port> UNNEST_GATE_OUT_ROOT=<abs_dir> UNNEST_GATE_KEYCACHE_TRIGGER=<n> UNNEST_GATE_KEYCACHE_MIN_DISTINCT=<n> UNNEST_GATE_KEYCACHE_MAX_TIDS=<n> UNNEST_GATE_SEGMENT_PREFETCH_SPAN=<n> UNNEST_GATE_LOCAL_HINT_MAX_KEYS=<n> UNNEST_GATE_ASSUME_UNIQUE_KEYS=<on|off> UNNEST_GATE_MIN_FRACTION=<0..1> UNNEST_GATE_STAT_MODE=<median|p05|p95|trimmed-mean> UNNEST_GATE_MIN_SAMPLES=<n> UNNEST_GATE_EXISTING_REF_DIR=<abs_dir> UNNEST_GATE_KEEP_NEW_DIR=<on|off> UNNEST_GATE_ALLOW_OPTIMISTIC_TAIL=<on|off> UNNEST_GATE_ALLOW_UNSAFE_UNIQUE=<on|off>"
	@echo "  make unnest-ab-gate-profile-throughput"
	@echo "  make unnest-ab-gate-profile-latency"
	@echo "  make unnest-ab-gate-profile-calibrated UNNEST_GATE_PROFILE_CALIBRATE_RUNS=<n> UNNEST_GATE_PROFILE_CALIBRATE_SAMPLES=<n> UNNEST_GATE_PROFILE_CALIBRATE_SCORE_MODE=<min|gmean> UNNEST_GATE_PROFILE_CALIBRATE_SET_STAT_MODE=<median|p05|p95|trimmed-mean> UNNEST_GATE_PROFILE_CALIBRATE_SET_MIN_SAMPLES=<n> UNNEST_GATE_PROFILE_CALIBRATE_MIN_SCORE_MARGIN=<ratio> UNNEST_GATE_PROFILE_CALIBRATE_MIN_QUANTILE_SCORE_MARGIN=<ratio> UNNEST_GATE_PROFILE_CALIBRATE_OUT_ROOT=<abs_dir> UNNEST_GATE_PROFILE_SELECTOR_SCRIPT=<path> UNNEST_GATE_PROFILE_CALIBRATE_THROUGHPUT_LOG=<abs_log|abs_dir> UNNEST_GATE_PROFILE_CALIBRATE_LATENCY_LOG=<abs_log|abs_dir>"
	...
	@echo "  UNNEST_AB_RUNS=$(UNNEST_AB_RUNS) UNNEST_AB_BATCH_SIZE=$(UNNEST_AB_BATCH_SIZE) UNNEST_AB_BATCHES=$(UNNEST_AB_BATCHES) UNNEST_AB_SELECT_ITERS=$(UNNEST_AB_SELECT_ITERS) UNNEST_AB_PROBE_SIZE=$(UNNEST_AB_PROBE_SIZE) UNNEST_AB_PORT=$(UNNEST_AB_PORT) UNNEST_AB_OUT=$(UNNEST_AB_OUT) UNNEST_AB_KEYCACHE_TRIGGER=$(UNNEST_AB_KEYCACHE_TRIGGER) UNNEST_AB_KEYCACHE_MIN_DISTINCT=$(UNNEST_AB_KEYCACHE_MIN_DISTINCT) UNNEST_AB_KEYCACHE_MAX_TIDS=$(UNNEST_AB_KEYCACHE_MAX_TIDS) UNNEST_AB_SEGMENT_PREFETCH_SPAN=$(UNNEST_AB_SEGMENT_PREFETCH_SPAN) UNNEST_AB_LOCAL_HINT_MAX_KEYS=$(UNNEST_AB_LOCAL_HINT_MAX_KEYS) UNNEST_AB_ASSUME_UNIQUE_KEYS=$(UNNEST_AB_ASSUME_UNIQUE_KEYS) UNNEST_AB_WARMUP_SELECTS=$(UNNEST_AB_WARMUP_SELECTS) UNNEST_SENTINEL_RUNS=$(UNNEST_SENTINEL_RUNS) UNNEST_SENTINEL_BATCH_SIZE=$(UNNEST_SENTINEL_BATCH_SIZE) UNNEST_SENTINEL_BATCHES=$(UNNEST_SENTINEL_BATCHES) UNNEST_SENTINEL_SELECT_ITERS=$(UNNEST_SENTINEL_SELECT_ITERS) UNNEST_SENTINEL_PROBE_SIZE=$(UNNEST_SENTINEL_PROBE_SIZE) UNNEST_SENTINEL_PORT=$(UNNEST_SENTINEL_PORT) UNNEST_SENTINEL_KEYCACHE_TRIGGER=$(UNNEST_SENTINEL_KEYCACHE_TRIGGER) UNNEST_SENTINEL_KEYCACHE_MIN_DISTINCT=$(UNNEST_SENTINEL_KEYCACHE_MIN_DISTINCT) UNNEST_SENTINEL_KEYCACHE_MAX_TIDS=$(UNNEST_SENTINEL_KEYCACHE_MAX_TIDS) UNNEST_SENTINEL_SEGMENT_PREFETCH_SPAN=$(UNNEST_SENTINEL_SEGMENT_PREFETCH_SPAN) UNNEST_SENTINEL_LOCAL_HINT_MAX_KEYS=$(UNNEST_SENTINEL_LOCAL_HINT_MAX_KEYS) UNNEST_SENTINEL_WARMUP_SELECTS=$(UNNEST_SENTINEL_WARMUP_SELECTS) UNNEST_SENTINEL_ENFORCE_THRESHOLDS=$(UNNEST_SENTINEL_ENFORCE_THRESHOLDS) UNNEST_SENTINEL_MIN_INSERT_RATIO=$(UNNEST_SENTINEL_MIN_INSERT_RATIO) UNNEST_SENTINEL_MIN_JOIN_UNNEST_RATIO=$(UNNEST_SENTINEL_MIN_JOIN_UNNEST_RATIO) UNNEST_SENTINEL_MIN_ANY_ARRAY_RATIO=$(UNNEST_SENTINEL_MIN_ANY_ARRAY_RATIO) UNNEST_AB_PROFILE_THROUGHPUT_KEYCACHE_TRIGGER=$(UNNEST_AB_PROFILE_THROUGHPUT_KEYCACHE_TRIGGER) UNNEST_AB_PROFILE_THROUGHPUT_KEYCACHE_MIN_DISTINCT=$(UNNEST_AB_PROFILE_THROUGHPUT_KEYCACHE_MIN_DISTINCT) UNNEST_AB_PROFILE_THROUGHPUT_KEYCACHE_MAX_TIDS=$(UNNEST_AB_PROFILE_THROUGHPUT_KEYCACHE_MAX_TIDS) UNNEST_AB_PROFILE_LATENCY_KEYCACHE_TRIGGER=$(UNNEST_AB_PROFILE_LATENCY_KEYCACHE_TRIGGER) UNNEST_AB_PROFILE_LATENCY_KEYCACHE_MIN_DISTINCT=$(UNNEST_AB_PROFILE_LATENCY_KEYCACHE_MIN_DISTINCT) UNNEST_AB_PROFILE_LATENCY_KEYCACHE_MAX_TIDS=$(UNNEST_AB_PROFILE_LATENCY_KEYCACHE_MAX_TIDS) UNNEST_AB_PROFILE_AUTO_THROUGHPUT_MIN_SELECT_ITERS=$(UNNEST_AB_PROFILE_AUTO_THROUGHPUT_MIN_SELECT_ITERS) UNNEST_AB_PROFILE_AUTO_THROUGHPUT_MIN_BATCHES=$(UNNEST_AB_PROFILE_AUTO_THROUGHPUT_MIN_BATCHES) UNNEST_AB_PROFILE_CALIBRATE_SCORE_MODE=$(UNNEST_AB_PROFILE_CALIBRATE_SCORE_MODE) UNNEST_AB_PROFILE_CALIBRATE_RUNS=$(UNNEST_AB_PROFILE_CALIBRATE_RUNS) UNNEST_AB_PROFILE_CALIBRATE_SAMPLES=$(UNNEST_AB_PROFILE_CALIBRATE_SAMPLES) UNNEST_AB_PROFILE_CALIBRATE_SET_STAT_MODE=$(UNNEST_AB_PROFILE_CALIBRATE_SET_STAT_MODE) UNNEST_AB_PROFILE_CALIBRATE_SET_MIN_SAMPLES=$(UNNEST_AB_PROFILE_CALIBRATE_SET_MIN_SAMPLES) UNNEST_AB_PROFILE_CALIBRATE_OUT_ROOT=$(UNNEST_AB_PROFILE_CALIBRATE_OUT_ROOT) UNNEST_AB_PROFILE_CALIBRATE_MIN_SCORE_MARGIN=$(UNNEST_AB_PROFILE_CALIBRATE_MIN_SCORE_MARGIN) UNNEST_AB_PROFILE_CALIBRATE_MIN_QUANTILE_SCORE_MARGIN=$(UNNEST_AB_PROFILE_CALIBRATE_MIN_QUANTILE_SCORE_MARGIN) UNNEST_AB_PROFILE_CALIBRATE_THROUGHPUT_LOG=$(UNNEST_AB_PROFILE_CALIBRATE_THROUGHPUT_LOG) UNNEST_AB_PROFILE_CALIBRATE_LATENCY_LOG=$(UNNEST_AB_PROFILE_CALIBRATE_LATENCY_LOG) UNNEST_AB_PROFILE_SELECTOR_SCRIPT=$(UNNEST_AB_PROFILE_SELECTOR_SCRIPT) UNNEST_AB_REF_DIR=$(UNNEST_AB_REF_DIR) UNNEST_AB_NEW_DIR=$(UNNEST_AB_NEW_DIR) UNNEST_AB_MIN_FRACTION=$(UNNEST_AB_MIN_FRACTION) UNNEST_AB_SET_STAT_MODE=$(UNNEST_AB_SET_STAT_MODE) UNNEST_AB_SET_MIN_SAMPLES=$(UNNEST_AB_SET_MIN_SAMPLES) UNNEST_AB_SELFTEST_TMP_ROOT=$(UNNEST_AB_SELFTEST_TMP_ROOT) UNNEST_GATE_REF_RUNS=$(UNNEST_GATE_REF_RUNS) UNNEST_GATE_NEW_RUNS=$(UNNEST_GATE_NEW_RUNS) UNNEST_GATE_BATCH_SIZE=$(UNNEST_GATE_BATCH_SIZE) UNNEST_GATE_BATCHES=$(UNNEST_GATE_BATCHES) UNNEST_GATE_SELECT_ITERS=$(UNNEST_GATE_SELECT_ITERS) UNNEST_GATE_PROBE_SIZE=$(UNNEST_GATE_PROBE_SIZE) UNNEST_GATE_BASE_PORT=$(UNNEST_GATE_BASE_PORT) UNNEST_GATE_OUT_ROOT=$(UNNEST_GATE_OUT_ROOT) UNNEST_GATE_KEYCACHE_TRIGGER=$(UNNEST_GATE_KEYCACHE_TRIGGER) UNNEST_GATE_KEYCACHE_MIN_DISTINCT=$(UNNEST_GATE_KEYCACHE_MIN_DISTINCT) UNNEST_GATE_KEYCACHE_MAX_TIDS=$(UNNEST_GATE_KEYCACHE_MAX_TIDS) UNNEST_GATE_SEGMENT_PREFETCH_SPAN=$(UNNEST_GATE_SEGMENT_PREFETCH_SPAN) UNNEST_GATE_LOCAL_HINT_MAX_KEYS=$(UNNEST_GATE_LOCAL_HINT_MAX_KEYS) UNNEST_GATE_ASSUME_UNIQUE_KEYS=$(UNNEST_GATE_ASSUME_UNIQUE_KEYS) UNNEST_GATE_MIN_FRACTION=$(UNNEST_GATE_MIN_FRACTION) UNNEST_GATE_STAT_MODE=$(UNNEST_GATE_STAT_MODE) UNNEST_GATE_MIN_SAMPLES=$(UNNEST_GATE_MIN_SAMPLES) UNNEST_GATE_EXISTING_REF_DIR=$(UNNEST_GATE_EXISTING_REF_DIR) UNNEST_GATE_ALLOW_UNSAFE_UNIQUE=$(UNNEST_GATE_ALLOW_UNSAFE_UNIQUE) UNNEST_GATE_SELFTEST_TMP_ROOT=$(UNNEST_GATE_SELFTEST_TMP_ROOT) UNNEST_GATE_PROFILE_SELECTOR_SCRIPT=$(UNNEST_GATE_PROFILE_SELECTOR_SCRIPT) UNNEST_GATE_PROFILE_CALIBRATE_SCORE_MODE=$(UNNEST_GATE_PROFILE_CALIBRATE_SCORE_MODE) UNNEST_GATE_PROFILE_CALIBRATE_RUNS=$(UNNEST_GATE_PROFILE_CALIBRATE_RUNS) UNNEST_GATE_PROFILE_CALIBRATE_SAMPLES=$(UNNEST_GATE_PROFILE_CALIBRATE_SAMPLES) UNNEST_GATE_PROFILE_CALIBRATE_SET_STAT_MODE=$(UNNEST_GATE_PROFILE_CALIBRATE_SET_STAT_MODE) UNNEST_GATE_PROFILE_CALIBRATE_SET_MIN_SAMPLES=$(UNNEST_GATE_PROFILE_CALIBRATE_SET_MIN_SAMPLES) UNNEST_GATE_PROFILE_CALIBRATE_OUT_ROOT=$(UNNEST_GATE_PROFILE_CALIBRATE_OUT_ROOT) UNNEST_GATE_PROFILE_CALIBRATE_MIN_SCORE_MARGIN=$(UNNEST_GATE_PROFILE_CALIBRATE_MIN_SCORE_MARGIN) UNNEST_GATE_PROFILE_CALIBRATE_MIN_QUANTILE_SCORE_MARGIN=$(UNNEST_GATE_PROFILE_CALIBRATE_MIN_QUANTILE_SCORE_MARGIN) UNNEST_GATE_PROFILE_CALIBRATE_THROUGHPUT_LOG=$(UNNEST_GATE_PROFILE_CALIBRATE_THROUGHPUT_LOG) UNNEST_GATE_PROFILE_CALIBRATE_LATENCY_LOG=$(UNNEST_GATE_PROFILE_CALIBRATE_LATENCY_LOG)"
	@echo "  UNNEST_STARTUP_RUNS=$(UNNEST_STARTUP_RUNS) UNNEST_STARTUP_BATCH_SIZE=$(UNNEST_STARTUP_BATCH_SIZE) UNNEST_STARTUP_BATCHES=$(UNNEST_STARTUP_BATCHES) UNNEST_STARTUP_SELECT_ITERS=$(UNNEST_STARTUP_SELECT_ITERS) UNNEST_STARTUP_PROBE_SIZE=$(UNNEST_STARTUP_PROBE_SIZE) UNNEST_STARTUP_PORT=$(UNNEST_STARTUP_PORT) UNNEST_STARTUP_KEYCACHE_TRIGGER=$(UNNEST_STARTUP_KEYCACHE_TRIGGER) UNNEST_STARTUP_KEYCACHE_MIN_DISTINCT=$(UNNEST_STARTUP_KEYCACHE_MIN_DISTINCT) UNNEST_STARTUP_KEYCACHE_MAX_TIDS=$(UNNEST_STARTUP_KEYCACHE_MAX_TIDS) UNNEST_STARTUP_SEGMENT_PREFETCH_SPAN=$(UNNEST_STARTUP_SEGMENT_PREFETCH_SPAN) UNNEST_STARTUP_LOCAL_HINT_MAX_KEYS=$(UNNEST_STARTUP_LOCAL_HINT_MAX_KEYS) UNNEST_STARTUP_PROBE_SCRIPT=$(UNNEST_STARTUP_PROBE_SCRIPT) UNNEST_STARTUP_GUARD_PROBE_SCRIPT=$(UNNEST_STARTUP_GUARD_PROBE_SCRIPT) UNNEST_STARTUP_SENTINEL_PROBE_SCRIPT=$(UNNEST_STARTUP_SENTINEL_PROBE_SCRIPT)"
