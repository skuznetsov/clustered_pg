...
require_path_filter_twice "$LIGHTWORKFLOW" ".github/workflows/fastpath-runtime-selftest.yml"
require_path_filter_twice "$LIGHTWORKFLOW" ".github/workflows/workflow-path-filter-sanity.yml"
require_path_filter_twice "$LIGHTWORKFLOW" "scripts/selftest_runtime_workflow_path_filters.sh"
...
require_path_filter_twice "$SANITY_WORKFLOW" ".github/workflows/fastpath-runtime-selftest.yml"
...
require_path_filter_twice "$SANITY_WORKFLOW" "scripts/selftest_runtime_workflow_path_filters.sh"
...
require_literal "$SANITY_WORKFLOW" "make runtime-workflow-path-filter-selftest workflow-path-filter-coverage-selftest workflow-files-guard-selftest lightweight-workflow-script-coverage-selftest selftest-script-baseline"
